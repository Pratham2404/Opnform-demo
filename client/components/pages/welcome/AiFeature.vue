    ...
    <div class="py-8">
      <section>
        <div class="mx-auto max-w-7xl isolate sm:px-6 lg:px-8">
          <div
            class="relative px-4 py-8 overflow-hidden bg-green-100 ring-blue-100 ring-1 sm:shadow-lg isolate sm:rounded-2xl sm:px-16 md:pt-20 lg:flex lg:gap-x-20 lg:px-16 lg:py-0 sm:shadow-gray-600/10">
