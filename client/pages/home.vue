          ...
          <div v-if="allTags.length > 0" class="mb-4 px-6">
            <div v-for="tag in allTags" :key="tag"
                 :class="[
                   ...
                   {'bg-green-50 text-blue-600 ring-blue-500/10 dark:bg-green-400':selectedTags.has(tag),
                    'bg-gray-50 text-gray-600 ring-gray-500/10 dark:bg-gray-700 hover:bg-green-50 hover:text-blue-600 hover:ring-blue-500/10 hover:dark:bg-green-400':!selectedTags.has(tag)}
                 ]"
...
useOpnSeoMeta({
  title: 'Your Forms',
  description: 'All of your Medkart forms are here. Create new forms, or update your existing forms.'
})
